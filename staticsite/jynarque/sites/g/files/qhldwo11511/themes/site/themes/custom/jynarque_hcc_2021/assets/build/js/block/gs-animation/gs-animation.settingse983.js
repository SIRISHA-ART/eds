...
(function ($, Drupal) {
  Drupal.behaviors.GSAnimation = {
    attach: function attach(context, settings) {
      $(once('GSAnimation', "#desContainer_C2")).each(function () {
        ...
        function updateSlider() {
          fadePictureAnimation(desPics.c2.p2, 0.1, tl.progress());
          fadePictureAnimation(desPics.c2.p3, 0.3, tl.progress());
          fadePictureAnimation(desPics.c2.p4, 0.6, tl.progress());
        }
